...
//           >
//             <a href="<?php echo $link; ?>" className="emptylink z-[2]">
//               .
//             </a>
...
//               <p className="text-[12px] leading-[1] tracking-[0.56px] 2xl:text-[14px] 3xl:text-[24px] mb-[40px] lg:mb-[37px] xl:mb-[45px] 2xl:mb-[64px] 3xl:mb-[112px] font-bold uppercase text-darkGray"></p>
//               <div className="date 2xl:mb-[12px] xl:mb-[9px] mb-[8px] 3xl:mb-[28px]">
//                 <span className="text-[14px] 2xl:text-[20px] 3xl:text-[30px] font-bold leading-[1.4] tracking-[0.1px] text-darkGray"></span>
//               </div>
//               <h4 className="lg:text-darkGray text-red 2xl:text-[32px] 3xl:text-[48px] transition-color duration-300 ease-in-out group-hover:text-red text-[20px] font-semibold mb-[6px] md:mb-[10px] xl:mb-[11px] 2xl:mb-[12px] 3xl:mb-[20px]"></h4>
//               <p className="font-medium text-darkGray mb-[17px] leading-[1.4] tracking-[0.1px] xl:mb-[26px] 2xl:mb-[31px] 3xl:mb-[99px]"></p>
...
//             >
//               <a href="<?php echo $small_card_link; ?>" className="emptylink z-[2]">
//                 .
//               </a>

//               <p className="text-[12px] 2xl:text-[14px] 3xl:text-[24px] 2xl:!mb-[110px] 3xl:group-hover:!mb-[80px] leading-[1] font-bold uppercase text-black lg:mb-[76px] xl:!mb-[90px]  group-hover:!mb-[32px] !mb-[30px] 2xl:group-hover:!mb-[48px] transition-all duration-300 ease-in-out"></p>
//               <div className="content relative">
//                 <h4 className="text-[20px] 2xl:text-[32px] 3xl:text-[48px] 3xl:mb-[20px]  font-semibold text-red group-hover:text-red lg:text-black transition-all duration-300 ease-in-out"></h4>
...
//                     <p className="2xl:text-[16px] xl:text-[12px] 3xl:text-[30px] text-black"></p>
//                   </div>
//                 </div>
